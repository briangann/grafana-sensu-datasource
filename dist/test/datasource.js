...
var _client_functions = require("./client_functions");

var _event_functions = require("./event_functions");

var _aggregate_functions = require("./aggregate_functions");

var _result_functions = require("./result_functions");

var _clienthistory_functions = require("./clienthistory_functions");

var _client_health_functions = require("./client_health_functions");
...
var SensuDatasource = exports.SensuDatasource = function () {
  ...
  _createClass(SensuDatasource, [{
    ...
    value: function getQueryURIByType(target) {
      ...
      switch (target.sourceType) {
        ...
        case 'aggregates_json':
          ...
          URIs = (0, _aggregate_functions.getAggregateURIs)(target, aggregateNames);
          break;
        ...
        case 'client_health_json':
          URIs = (0, _client_health_functions.getClientHealthURIs)(clientNames);
          break;
        case 'clients':
        case 'clients_json':
          // https://sensuapp.org/docs/0.28/api/clients-api.html
          URIs = (0, _client_functions.getClientsURIs)(checkNames, clientNames);
          break;
        case 'clienthistory':
          // https://sensuapp.org/docs/0.28/api/clients-api.html
          // look for clientName in dimensions
          URIs = (0, _clienthistory_functions.getClientHistoryURIs)(clientNames);
          break;
        case 'event_metrics':
        ...
        case 'events_json':
          ...
          URIs = (0, _event_functions.getEventsURIs)(checkNames, clientNames);
          break;
        case 'results_json':
        case 'results_table':
          // https://sensuapp.org/docs/0.28/api/results-api.html
          URIs = (0, _result_functions.getResultURIs)(checkNames, clientNames);
          break;
    ...
    value: function processConversions(sourceType, aTarget, responses) {
      ...
      switch (sourceType) {
        case 'aggregates':
          result = (0, _aggregate_functions.convertAggregatesToDataPoints)(aTarget, responses);
          break;
        case 'aggregates_json':
          result = (0, _aggregate_functions.convertAggregatesToJSON)(aTarget, responses);
          return result;
        case 'clients':
          result = (0, _client_functions.convertClientsToDataPoints)(aTarget, responses);
          return result;
        case 'clients_json':
          result = (0, _client_functions.convertClientsToJSON)(aTarget, responses);
          return result;
        case 'client_health_json':
          result = (0, _client_health_functions.convertClientHealthToJSON)(aTarget, responses);
          return result;
        case 'clienthistory':
          result = (0, _client_functions.convertClientHistoryToDataPoints)(aTarget, responses);
          break;
        case 'events':
          result = (0, _event_functions.convertEventsToDataPoints)(aTarget, responses);
          break;
        case 'events_json':
          result = (0, _event_functions.convertEventsToJSON)(aTarget, responses);
          break;
        case 'event_metrics':
          result = (0, _event_functions.convertEventsToEventMetrics)(aTarget, responses);
          break;
        case 'event_metrics_json':
          result = (0, _event_functions.convertEventsToEventMetricsJSON)(aTarget, responses);
          break;
        case 'results_json':
          result = (0, _result_functions.convertResultsToJSON)(aTarget, responses);
          break;
        case 'results_table':
          result = (0, _result_functions.convertResultsToTable)(aTarget, responses);
          break;
        default:
