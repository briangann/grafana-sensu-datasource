...
System.register(['./common'], function (_export, _context) {
  ...
  function convertResultsToDataPoints(aTarget, responses) {
    ...
    execute: function () {
      _export('getResultURIs', getResultURIs);

      _export('convertResultsToTable', convertResultsToTable);

      _export('convertResultsToDataPoints', convertResultsToDataPoints);

      _export('convertResultsToJSON', convertResultsToJSON);
    }
  };
});
