...
System.register(['./common'], function (_export, _context) {
  ...
  function convertEventsToEventMetrics(aTarget, responses) {
    ...
    execute: function () {
      _export('convertEventsToJSON', convertEventsToJSON);

      _export('convertEventsToDataPoints', convertEventsToDataPoints);

      _export('convertEventsToEventMetrics', convertEventsToEventMetrics);

      _export('convertEventsToEventMetricsJSON', convertEventsToEventMetricsJSON);

      _export('getEventsURIs', getEventsURIs);

      _export('includeEventTarget', includeEventTarget);
    }
  };
});
